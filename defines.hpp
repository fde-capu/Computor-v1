...
# define MSG_DISC_NEG "Discriminant is negative, the polynomial has two distinct complex roots."
# define MSG_OVER_DEGREE "The polynomial degree is strictly greater than 2, I can't solve."
