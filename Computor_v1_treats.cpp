...
void Computor_v1::treat_spaces()
{
	...
	verbose(V) << "treat_spaces 1: " << this->treating << std::endl;
	substitute_unloop(this->treating, "\\t", " ");
	verbose(V) << "treat_spaces 2: " << this->treating << std::endl;
	substitute_unloop(this->treating, " *", " 0*");
	verbose(V) << "treat_spaces 3: " << this->treating << std::endl;
	substitute_unloop(this->treating, "*", " * ");
	verbose(V) << "treat_spaces 4: " << this->treating << std::endl;
	substitute_unloop(this->treating, "/", " / ");
	verbose(V) << "treat_spaces 5: " << this->treating << std::endl;
	substitute_unloop(this->treating, "+", " + ");
	verbose(V) << "treat_spaces 6: " << this->treating << std::endl;
	substitute_unloop(this->treating, "-", " - ");
	verbose(V) << "treat_spaces 7: " << this->treating << std::endl;
	substitute_unloop(this->treating, "=", " = ");
	verbose(V) << "treat_spaces 8: " << this->treating << std::endl;
	substitute_super(this->treating, " ^", "^");
	verbose(V) << "treat_spaces 9: " << this->treating << std::endl;
	substitute_super(this->treating, "^ ", "^");
	verbose(V) << "treat_spaces 10: " << this->treating << std::endl;
	substitute_super(this->treating, "* ", "*");
	verbose(V) << "treat_spaces 11: " << this->treating << std::endl;
	substitute_super(this->treating, " *", "*");
	verbose(V) << "treat_spaces 12: " << this->treating << std::endl;
	substitute_super(this->treating, "/ ", "/");
	verbose(V) << "treat_spaces 13: " << this->treating << std::endl;
	substitute_super(this->treating, " /", "/");
	verbose(V) << "treat_spaces 14: " << this->treating << std::endl;
	substitute_super(this->treating, "- ", "-");
	verbose(V) << "treat_spaces 15: " << this->treating << std::endl;
	substitute_super(this->treating, "+ ", "+");
	verbose(V) << "treat_spaces 16: " << this->treating << std::endl;
	substitute_super(this->treating, "  ", " ");
	verbose(V) << "treat_spaces 17: " << this->treating << std::endl;
