...
"Passing only 'b'" \
"42.31x^1 = 0" \
"(debug)Reduced form: +42.31*x^1 = 0
Polynomial degree: 1
...
"Passing 'b' and 'c'" \
"42x^1 + 7 = 0" \
"(debug)Reduced form: +42*x^1 +7*x^0 = 0
Polynomial degree: 1
Equation is first degree. One solution:
-0.166667";
...
"(debug)Reduced form: -1.1*x^2 +2.1*x^1 +1*x^0 = 0
Polynomial degree: 2
...
"(debug)Reduced form: -10.3*x^2 +4*x^1 +5.1*x^0 = 0
Polynomial degree: 2
...
"(debug)Reduced form: -9.3*x^2 +4*x^1 +4*x^0 = 0
Polynomial degree: 2
...
"i17" \
"5 * X^0 + 4 * X^1 = 4 * X^0" \
"(debug)Reduced form: +4*x^1 +1*x^0 = 0
Polynomial degree: 1
Equation is first degree. One solution:
-0.25"
...
"(debug)Reduced form: -5.6*x^3 -6*x^1 +5*x^0 = 0
Polynomial degree: 3
The polynomial degree is strictly greater than 2, I can't solve."
